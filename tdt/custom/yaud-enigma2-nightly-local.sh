...
rm $CHANGEDIR/release_with_dev/lib/modules/pti.ko
mv $CHANGEDIR/release_with_dev/lib/modules/pti_209.ko $CHANGEDIR/release_with_dev/lib/modules/pti.ko
$CHANGEDIR/host/bin/mkfs.jffs2 -r $CHANGEDIR/release_with_dev/ -o ../../flash/spark/e2jffs2.img -e 0x20000 -pn
cp $CHANGEDIR/release_with_dev/boot/uImage ../../flash/spark/
	exit
fi
echo "--- Erledigt ---"
exit
